...
jQuery.Velocity ? console.log('Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.') : (function (t) {
  ...
  if (!t.jQuery) {
    ...
    i.extend = function () {
      ...
      }, l++), 'object' != typeof s && 'function' !== i.type(s) && (s = {
      }), l === c && (s = this, l--); c > l; l++) if (null != (a = arguments[l])) for (o in a) t = s[o],
      s !== (n = a[o]) && (u && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, r = t && i.isArray(t) ? t : [
    ...
    i.uuid = 0;
    for (var o = {
    }, a = o.hasOwnProperty, r = o.toString, s = 'Boolean Number String Function Array Date RegExp Object Error'.split(' '), l = 0; l < s.length; l++) o['[object ' + s[l] + ']'] = s[l].toLowerCase();
  ...
  return function (t, e, i, n) {
    ...
    function a(t) {
      return v.isWrapped(t) ? t = [
      ].slice.call(t) : v.isNode(t) && (t = [
        t
      ]),
      t
    }
    ...
    function u(t) {
      if (t) {
        ...
        i > 10000 && (b.State.calls = o(b.State.calls));
        for (var a = 0; i > a; a++) if (b.State.calls[a]) {
          ...
          for (var g = Math.min((e - h) / c.duration, 1), y = 0, w = l.length; w > y; y++) {
            ...
            if (r(T)) {
              ...
              c.mobileHA && r(T).transformCache.translate3d === n && (r(T).transformCache.translate3d = '(0px, 0px, 0px)', S = !0),
      ...
      if (!(7 >= h)) {
        ...
        var w = function () {
          ...
          return function t(e, n, o) {
            ...
            u = 0;
            for (e = parseFloat(e) || 500, n = parseFloat(n) || 20, o = o || null, l.tension = e, l.friction = n, (a = null !== o) ? (u = t(e, n), r = u / o * 0.016) : r = 0.016; s = i(s || l, r), c.push(1 + s.x), u += 16, Math.abs(s.x) > 0.0001 && Math.abs(s.v) > 0.0001; );
            return a ? function (t) {
        ...
        var k = b.CSS = {
          ...
          Hooks: {
            ...
            register: function () {
              ...
              if (h) for (e in k.Hooks.templates) {
                ...
                'Color' === n[0] && (n.push(n.shift()), o.push(o.shift()), k.Hooks.templates[e] = [
                  n.join(' '),
                  o.join(' ')
                ])
              }
            ...
            registered: {
              clip: function (t, e, i) {
                switch (t) {
                  ...
                  case 'extract':
                    var n;
                    return k.RegEx.wrappedValueAlreadyExtracted.test(i) ? n = i : (n = i.toString().match(k.RegEx.valueUnwrap), n = n ? n[1].replace(/,(\s+)?/g, ' ') : i),
                    n;
                  case 'inject':
                    return 'rect(' + i + ')'
                }
          ...
          Names: {
            ...
            prefixCheck: function (t) {
              if (b.State.prefixMatches[t]) return [b.State.prefixMatches[t],
              !0];
              for (var e = [
                '',
                'Webkit',
                ...
                }), v.isString(b.State.prefixElement.style[o])) return b.State.prefixMatches[t] = o,
                [
                  o,
                  !0
                ]
          ...
          getPropertyValue: function (t, i, o, a) {
            ...
            if (k.Hooks.registered[i]) {
              ...
              var d,
              f;
              'transform' !== (d = k.Normalizations.registered[i]('name', t)) && (f = s(t, k.Names.prefixCheck(d) [0]), k.Values.isCSSNullValue(f) && k.Hooks.templates[i] && (f = k.Hooks.templates[i][1])),
          ...
          setPropertyValue: function (t, i, n, o, a) {
            ...
            if ('scroll' === i) a.container ? a.container['scroll' + a.direction] = n : 'Left' === a.direction ? e.scrollTo(n, a.alternateValue) : e.scrollTo(a.alternateValue, n);
             else if (k.Normalizations.registered[i] && 'transform' === k.Normalizations.registered[i]('name', t)) k.Normalizations.registered[i]('inject', t, n),
            s = 'transform',
          ...
          flushTransformCache: function (t) {
            ...
            if ((h || b.State.isAndroid && !b.State.isChrome) && r(t).isSVG) {
              ...
              p.each(r(t).transformCache, function (e) {
                ...
                'transformPerspective' === e ? (a = o, !0) : (9 === h && 'rotateZ' === e && (e = 'rotate'), void (i += e + o + ' '))
              }),
              a && (i = 'perspective' + a + ' ' + i)
            }
        ...
        var x = function () {
          ...
          function o() {
            function t(t) {
              function d(t, e) {
                ...
                o = n,
                r = n;
                return v.isArray(t) ? (i = t[0], !v.isArray(t[1]) && /^[\d-]/.test(t[1]) || v.isFunction(t[1]) || k.RegEx.isHex.test(t[1]) ? r = t[1] : (v.isString(t[1]) && !k.RegEx.isHex.test(t[1]) || v.isArray(t[1])) && (o = e ? t[1] : c(t[1], s.duration), t[2] !== n && (r = t[2]))) : i = t,
                e || (o = o || s.easing),
              ...
              if ('scroll' === A) {
                  ...
                  if (RegExp('^' + k.Lists.colors.join('$|^') + '$').test(t)) {
                    ...
                    if (k.RegEx.isHex.test(o)) {
                      for (var s = [
                        ...
                        'Green',
                        'Blue'
                      ], l = k.Values.hexToRgb(o), c = r ? k.Values.hexToRgb(r) : n, u = 0; u < s.length; u++) {
                        var p = [
                          l[u]
                        ];
                        a && p.push(a),
                ...
                for (var q in m) {
                  ...
                  if (r(a).isSVG || 'tween' === j || !1 !== k.Names.prefixCheck(j) [1] || k.Normalizations.registered[j] !== n) {
                    ...
                    s._cacheValues && M && M[q] ? (L === n && (L = M[q].endValue + M[q].unitType), $ = r(a).rootPropertyValueCache[j]) : k.Hooks.registered[q] ? L === n ? ($ = k.getPropertyValue(a, j), L = k.getPropertyValue(a, q, $)) : $ = k.Hooks.templates[j][1] : L === n && (L = k.getPropertyValue(a, q));
                    var N,
                    W,
                    F,
                    Q = !1;
                    if (N = h(q, L), L = N[0], F = N[1], N = h(q, V), V = N[0].replace(/^([+-\/*])=/, function (t, e) {
                      ...
                      o = o || function () {
                        ...
                        null === I.vwToPx && (I.vwToPx = parseFloat(e.innerWidth) / 100, I.vhToPx = parseFloat(e.innerHeight) / 100),
                        l.remToPx = I.remToPx,
                        l.vwToPx = I.vwToPx,
                        l.vhToPx = I.vhToPx,
              ...
              l.element && (k.Values.addClass(a, 'velocity-animating'), D.push(l), '' === s.queue && (r(a).tweensContainer = l, r(a).opts = s), r(a).isAnimating = !0, T === C - 1 ? (b.State.calls.push([D,
              f,
              s,
              null,
              P.resolver]), !1 === b.State.isTicking && (b.State.isTicking = !0, u())) : T++)
            }
            var o,
            a = this,
            s = p.extend({
            ...
            s.display !== n && null !== s.display && (s.display = s.display.toString().toLowerCase(), 'auto' === s.display && (s.display = b.CSS.Values.getDisplayType(a))),
          ...
          if (v.isWrapped(this) ? (s = !1, h = 0, f = this, l = this) : (s = !0, h = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = a(f)) {
              ...
              default:
                if (!p.isPlainObject(m) || v.isEmptyObject(m)) {
                  if (v.isString(m) && b.Redirects[m]) {
                    ...
                    _ = z.delay || 0;
                    return !0 === z.backwards && (f = p.extend(!0, [
                    ], f).reverse()),
                    p.each(f, function (t, e) {
                      parseFloat(z.stagger) ? z.delay = _ + parseFloat(z.stagger) * t : v.isFunction(z.stagger) && (z.delay = _ + z.stagger.call(e, t, C)),
                      z.drag && (z.duration = parseFloat(E) || (/^(callout|transition)/.test(m) ? 1000 : g), z.duration = Math.max(z.duration * (z.backwards ? 1 - t / C : (t + 1) / C), 0.75 * z.duration, 200)),
                      b.Redirects[m].call(e, e, z || {
                      }, t, C, f, P.promise ? P : n)
                    }),
                    t()
                  }
            ...
            if (z.loop = parseInt(z.loop), q = 2 * z.loop - 1, z.loop) for (var V = 0; q > V; V++) {
              ...
              V === q - 1 && (H.display = z.display, H.visibility = z.visibility, H.complete = z.complete),
              x(f, 'reverse', H)
            }
            return t()
          }
...
function (t, e, i, n) {
  ...
  function s(t, e, i) {
    for (var o = Object.keys(e), a = 0; a < o.length; ) (!i || i && t[o[a]] === n) && (t[o[a]] = e[o[a]]),
    a++;
    return t
  }
  function l(t, e) {
  ...
  function M(t) {
    ...
    for (var i = 0, n = 0, o = 0; e > o; ) i += t[o].clientX,
    n += t[o].clientY,
    o++;
    return {
      x: dt(i / e),
  ...
  function F(t, e) {
    var i = b(t.touches),
    n = this.targetIds;
    if (e & (xt | Ct) && 1 === i.length) return n[i[0].identifier] = !0,
    [
      i,
      i
    ];
  ...
  t.MSPointerEvent && (Nt = 'MSPointerDown', Wt = 'MSPointerMove MSPointerUp MSPointerCancel'),
  c(j, T, {
    handler: function (t) {
      var e = this.store,
      i = !1,
      ...
      o & xt && (0 === t.button || r) ? 0 > s && (e.push(t), s = e.length - 1) : o & (Tt | St) && (i = !0),
  ...
  Y.prototype = {
    ...
    recognize: function (t) {
      ...
      return d(this.options.enable, [
        this,
        e
      ]) ? (this.state & (re | se | 32) && (this.state = ie), this.state = this.process(e), void (this.state & (ne | oe | ae | se) && this.tryEmit(e))) : (this.reset(), void (this.state = 32))
    },
    process: function () {
    },
  ...
  c(J, Z, {
    ...
    directionTest: function (t) {
      ...
      a = t.deltaX,
      r = t.deltaY;
      return o & e.direction || (e.direction & Mt ? (o = 0 === a ? Pt : 0 > a ? At : Ot, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? Pt : 0 > r ? Et : _t, i = r != this.pY, n = Math.abs(t.deltaY))),
      t.direction = o,
  ...
  c(tt, Y, {
    ...
    process: function (t) {
      ...
      if (this._input = t, !n || !i || t.eventType & (Tt | St) && !a) this.reset();
       else if (t.eventType & xt) this.reset(),
...
function (t) {
  ...
  'hammerjs'], t) : 'object' == typeof exports ? t(require('jquery'), require('hammerjs')) : t(jQuery, Hammer)
}(function (t, e) {
  function i(i, n) {
    var o = t(i);
...
function (t) {
  for (var e = 0, i = [
    'webkit',
    'moz'
  ], n = t.requestAnimationFrame, o = t.cancelAnimationFrame, a = i.length; --a >= 0 && !n; ) n = t[i[a] + 'RequestAnimationFrame'],
...
Materialize.throttle = function (t, e, i) {
  ...
  return function () {
    ...
    return n = this,
    o = arguments,
    u <= 0 ? (clearTimeout(r), r = null, s = c, a = t.apply(n, o), n = o = null) : r || !1 === i.trailing || (r = setTimeout(l, u)),
    a
  }
};
var Vel;
...
function (t, e) {
  ...
  n = function () {
    function n(e, i) {
      ...
      n._increment++,
      n._count++,
      this.$overlay[0].style.zIndex = 1000 + 2 * n._increment,
      this.$el[0].style.zIndex = 1000 + 2 * n._increment + 1,
      ...
      },
      {
        ...
        value: function () {
          ...
          this.$el[0].classList.contains('bottom-sheet') ? e(this.$el[0], {
            bottom: 0,
            opacity: 1
          }, n) : (e.hook(this.$el[0], 'scaleX', 0.7), this.$el[0].style.top = this.options.startingTop, e(this.$el[0], {
      ...
      if (!t(this).hasClass('initialized')) {
        ...
        s.on('click', function () {
          ...
          for (; null !== n && !t(n).is(document); ) {
            var p = t(n);
            'visible' !== p.css('overflow') && (p.css('overflow', 'visible'), i = void 0 === i ? p : i.add(p)),
            n = n.parentNode
          }
          s.css({
            position: 'absolute',
          ...
          var m = 0,
          g = 0;
          u / l > d / c ? (m = 0.9 * l, g = 0.9 * l * (d / u)) : (m = 0.9 * c * (u / d), g = 0.9 * c),
        ...
        u.off('click.tabs').on('click.tabs', 'a', function (i) {
          if (t(this).parent().hasClass('disabled')) i.preventDefault();
            ...
            e.swipeable ? f.length && f.carousel('set', m, function () {
              'function' == typeof e.onShow && e.onShow.call(u[0], a)
            }) : (void 0 !== a && (a.show(), a.addClass('active'), 'function' == typeof e.onShow && e.onShow.call(this, a)), void 0 === n || n.is(a) || (n.hide(), n.removeClass('active'))),
      ...
      },
      {
        ...
        value: function (t) {
          if (n._draggedToast) {
            ...
            var i = e.xPos - e.startingXPos,
            o = e.el.offsetWidth * e.options.activationPercent;
            Math.abs(i) > o || e.velocityX > 1 ? (e.wasSwiped = !0, e.remove()) : (e.el.style.transition = 'transform .2s, opacity .2s', e.el.style.transform = '', e.el.style.opacity = ''),
  ...
  var e = {
    init: function (e) {
      ...
      t(this).each(function () {
        ...
        e.draggable ? (a.length && a.remove(), a = t('<div class="drag-target"></div>').attr('data-sidenav', n), t('body').append(a)) : a = t(),
        'left' == e.edge ? (o.css('transform', 'translateX(-100%)'), a.css({
          left: 0
        ...
        e.draggable && (a.on('click', function () {
          ...
          if ('touch' == i.gesture.pointerType) {
            ...
            if (s.css('overflow', 'hidden'), s.width(u), 0 === c.length && ((c = t('<div id="sidenav-overlay"></div>')).css('opacity', 0).click(function () {
              r()
            }), 'function' == typeof e.onOpen && e.onOpen.call(this, o), t('body').append(c)), 'left' === e.edge && (n > e.menuWidth ? n = e.menuWidth : n < 0 && (n = 0)), 'left' === e.edge) n < e.menuWidth / 2 ? l = !1 : n >= e.menuWidth / 2 && (l = !0),
          ...
          if ('touch' == i.gesture.pointerType) {
            ...
            d < 0 && (d = 0),
            s = !1,
            'left' === e.edge ? l && r <= 0.3 || r < - 0.5 ? (0 !== u && o.velocity({
              translateX: [
                0,
                u
              ]
...
function (t) {
  ...
  t.scrollSpy = function (e, n) {
    ...
    return s || (o.on('scroll', d), o.on('resize', d), s = !0),
    setTimeout(d, 0),
    e.on('scrollSpy:enter', function () {
      ...
      var e = t(this);
      l[0] ? (t(n.getActiveElement(l[0].attr('id'))).removeClass(n.activeClass), e.data('scrollSpy:id') < l[0].data('scrollSpy:id') ? l.unshift(t(this)) : l.push(t(this))) : l.push(t(this)),
...
function (t) {
  t(document).ready(function () {
    ...
    t(document).on('keyup.radio', 'input[type=radio], input[type=checkbox]', function (e) {
      if (9 === e.which) return t(this).addClass('tabbed'),
    ...
    t(document).on('change', '.file-field input[type="file"]', function () {
      ...
      ], o = 0; o < i.length; o++) n.push(i[o].name);
      e.val(n.join(', ')),
      e.trigger('change')
    });
  ...
  t.fn.material_select = function (e) {
    ...
    t(this).each(function () {
      ...
      if (!n.hasClass('browser-default')) {
        ...
        if (a && (n.parent().find('span.caret').remove(), n.parent().find('input').remove(), n.unwrap(), t('ul#select-options-' + a).remove()), 'destroy' === e) return n.removeAttr('data-select-id').removeClass('initialized'),
          ...
          t(this).click(function (r) {
            if (!t(this).hasClass('disabled') && !t(this).hasClass('optgroup')) {
              ...
              o ? (t('input[type="checkbox"]', this).prop('checked', function (t, e) {
                return !e
              }), s = i(u, a, n), m.trigger('focus')) : (l.find('li').removeClass('active'), t(this).toggleClass('active'), m.val(t(this).text())),
              g(l, t(this)),
        ...
        m.on('keydown', function (e) {
          if (9 != e.which) if (40 != e.which || l.is(':visible')) {
            if (13 != e.which || l.is(':visible')) {
              ...
              40 == e.which && (r = l.find('li.selected').length ? l.find('li.selected').next('li:not(.disabled)') [0] : l.find('li:not(.disabled)') [0], g(l, r)),
    ...
    init: function (e) {
      ...
      this.each(function () {
        ...
        function n(t) {
          ...
          (u = l.find('.active').index()) != t && (o = c.eq(u), $caption = o.find('.caption'), o.removeClass('active'), o.velocity({
            opacity: 0
          }, {
        ...
        e.indicators && (a = t('<ul class="indicators"></ul>'), c.each(function (i) {
          ...
          a.append(o)
        }), s.append(a), a = s.find('ul.indicators').find('li.indicator-item')),
        o ? o.show() : (c.first().addClass('active').velocity({
          ...
          queue: !1,
          easing: 'easeOutQuad'
        }), u = 0, o = c.eq(u), e.indicators && a.eq(u).addClass('active')),
        ...
        s.hammer({
          ...
          if ('touch' === t.gesture.pointerType) {
            ...
            4 === e && (i > s.innerWidth() / 2 || n < - 0.65) ? h = !0 : 2 === e && (i < - 1 * s.innerWidth() / 2 || n > 0.65) && (p = !0);
            var a;
  ...
  t.fn.material_chip = function (i) {
    ...
    this.handleEvents = function () {
      ...
      n.$document.off('keydown.chips-add', e.CHIPS + ' ' + e.INPUT).on('keydown.chips-add', e.CHIPS + ' ' + e.INPUT, function (i) {
        ...
        if ((8 === i.keyCode || 37 === i.keyCode) && '' === o.val() && r) return i.preventDefault(),
        n.selectChip(r - 1, a),
        void o.blur()
      }),
    ...
    this.addChip = function (t, e) {
      if (n.isValid(e, t)) {
        for (var i = n.renderChip(t), o = [
        ], a = e.data('chips'), r = 0; r < a.length; r++) o.push(a[r]);
        o.push(t),
        e.data('chips', o),
    ...
    this.deleteChip = function (t, e) {
      ...
      for (var o = [
      ], a = e.data('chips'), r = 0; r < a.length; r++) r !== t && o.push(a[r]);
      e.data('chips', o),
...
function (t) {
  ...
  function e(a, s, u, d) {
    ...
    function v() {
      var e;
      !0 === w.hiddenName ? (e = a.name, a.name = '') : e = (e = [
    ...
    T = C.prototype = {
      ...
      start: function () {
        ...
        }, b.start = !0, b.open = !1, b.type = a.type, a.autofocus = a == r(), a.readOnly = !w.editable, a.id = a.id || b.id, 'text' != a.type && (a.type = 'text'), T.component = new u(T, w), T.$root = t(e._.node('div', p(), k.picker, 'id="' + a.id + '_root" tabindex="0"')), f(), w.formatSubmit && v(), h(), w.container ? t(w.container).append(T.$root) : x.before(T.$root), T.on({
      ...
      stop: function () {
        return b.start ? (T.close(), T._hidden && T._hidden.parentNode.removeChild(T._hidden), T.$root.remove(), x.removeClass(k.input).removeData(s), setTimeout(function () {
          x.off('.' + b.id)
        }, 0), a.type = b.type, a.readOnly = !1, T.trigger('stop'), b.methods = {
        }, b.start = !1, T) : T
      },
      open: function (i) {
        return b.open ? T : (x.addClass(k.active), o(a, 'expanded', !0), setTimeout(function () {
          ...
          o = T.component.key[n],
          a = i.target;
          27 == n ? T.close(!0) : a != T.$root[0] || !o && 13 != n ? t.contains(T.$root[0], a) && 13 == n && (i.preventDefault(), a.click()) : (i.preventDefault(), o ? e._.trigger(T.component.key.go, T, [
            e._.trigger(o)
          ]) : T.$root.find('.' + k.highlighted).hasClass(k.disabled) || (T.set('select', T.component.item.highlight), w.closeOnSelect && T.close(!0)))
        })), T.trigger('open'))
      },
      close: function (t) {
        ...
        b.open ? (b.open = !1, y && c.css('overflow', '').css('padding-right', '-=' + n()), l.off('.' + b.id), T.trigger('close')) : T
      },
      clear: function (t) {
      ...
      get: function (t, i) {
        ...
        if (t in T.component.item) {
          if ('string' == typeof i) {
            ...
            return n ? e._.trigger(T.component.formats.toString, T.component, [
              i,
              n
            ]) : ''
          }
  ...
  e._ = {
    group: function (t) {
      for (var i, n = '', o = e._.trigger(t.min, t); o <= e._.trigger(t.max, t, [
        o
      ]); o += t.i) i = e._.trigger(t.item, t, [
        o
      ]),
    ...
    trigger: function (t, e, i) {
      return 'function' == typeof t ? t.apply(e, i || [
      ]) : t
    },
    digits: function (t) {
  ...
  e.extend = function (i, n) {
    t.fn[i] = function (o, a) {
      var r = this.data(i);
      return 'picker' == o ? r : r && 'string' == typeof o ? e._.trigger(r[o], r, [
        a
      ]) : this.each(function () {
...
function (t) {
  ...
  i.prototype.create = function (t, i, o) {
    ...
    i == - 1 / 0 || i == 1 / 0 ? a = i : e.isPlainObject(i) && n.isInteger(i.pick) ? i = i.obj : e.isArray(i) ? (i = new Date(i[0], i[1], i[2]), i = n.isDate(i) ? i : r.create().obj) : i = n.isInteger(i) || n.isDate(i) ? r.normalize(new Date(i), o) : r.now(t, i, o),
    {
  ...
  i.prototype.createRange = function (t, i) {
    ...
    n.isInteger(i) || (i = a(i)),
    n.isInteger(t) && e.isPlainObject(i) ? t = [
      i.year,
      i.month,
      i.date + t
    ] : n.isInteger(i) && e.isPlainObject(t) && (i = [
      t.year,
      t.month,
      t.date + i
    ]),
  ...
  i.prototype.validate = function (t, i, o) {
    ...
    if ((!o || !o.nav) && (!p && c.disabled(i) || p && c.disabled(i) && (v || a || r) || !p && (i.pick <= h.pick || i.pick >= f.pick))) for (p && !v && (!r && d > 0 || !a && d < 0) && (d *= - 1); c.disabled(i) && (Math.abs(d) > 1 && (i.month < u.month || i.month > u.month) && (i = u, d = d > 0 ? 1 : - 1), i.pick <= h.pick ? (s = !0, d = 1, i = c.create([h.year,
    h.month,
    h.date + (i.pick === h.pick ? 0 : - 1)])) : i.pick >= f.pick && (l = !0, d = - 1, i = c.create([f.year,
    f.month,
    f.date + (i.pick === f.pick ? 0 : 1)])), !s || !l); ) i = c.create([i.year,
    i.month,
    i.date + d]);
    return i
  },
  ...
  i.prototype.parse = function (t, e, i) {
    ...
    }).format = o.settings.format), o.formats.toArray(i.format).map(function (t) {
      var i = o.formats[t],
      r = i ? n.trigger(i, o, [
        e,
        a
    ...
    return {
      ...
      toString: function (t, e) {
        ...
        return i.formats.toArray(t).map(function (t) {
          return n.trigger(i.formats[t], i, [
            0,
            e
          ]) || t.replace(/^!/, '')
        }).join('')
  ...
  i.prototype.deactivate = function (t, i) {
    ...
    return 'flip' == i ? o.flipEnable() : !1 === i ? (o.flipEnable(1), a = [
    ]) : !0 === i ? (o.flipEnable( - 1), a = [
    ]) : i.map(function (t) {
  ...
  i.prototype.activate = function (t, i) {
    ...
    a = o.item.disable,
    r = a.length;
    return 'flip' == i ? o.flipEnable() : !0 === i ? (o.flipEnable(1), a = [
    ]) : !1 === i ? (o.flipEnable( - 1), a = [
    ]) : i.map(function (t) {
      var i,
      s,
      l,
      ...
      for (l = 0; l < r; l += 1) {
        ...
        if (o.isDateOverlap(s, t)) {
          e.isPlainObject(t) ? (t.inverted = !0, i = t) : e.isArray(t) ? (i = t) [3] || i.push('inverted') : n.isDate(t) && (i = [
            t.getFullYear(),
            t.getMonth(),
            t.getDate(),
            'inverted'
  ...
  i.prototype.nodes = function (t) {
    ...
    d = o.max,
    p = function (t, e) {
      return i.firstDay && (t.push(t.shift()), e.push(e.shift())),
    ...
    f = function (o) {
      ...
      i.selectMonths && void 0 == o ? n.node('select', n.group({
        ...
        item: function (t) {
          return [a[t],
          0,
          'value=' + t + (l.month == t ? ' selected' : '') + (l.year == u.year && t < u.month || l.year == d.year && t > d.month ? ' disabled' : '')]
        }
    ...
    n.node('div', n.node('div', v('raw'), i.klass.year_display) + n.node('span', createWeekdayLabel() + ', ', 'picker__weekday-display') + n.node('span', f('short_months') + ' ', i.klass.month_display) + n.node('span', createDayLabel(), i.klass.day_display), i.klass.date_display) + n.node('div', n.node('div', n.node('div', (i.selectYears, f() + v() + h() + h(1)), i.klass.header) + n.node('table', p + n.node('tbody', n.group({
      ...
      node: 'tr',
      item: function (t) {
        var o = i.firstDay && 0 === e.create([l.year,
        l.month,
        1]).day ? - 7 : 0;
        return [n.group({
          min: 7 * t - l.day + o + 1,
...
function (t) {
  ...
  function o(o, r) {
    function l(t, e) {
      ...
      if (!e || !(u < y - w || u > y + w)) {
        ...
        s.off(f).on(f, function (t) {
          ...
          'hours' === E.currentView ? E.toggleView('minutes', x / 2) : r.autoclose && (E.minutesView.addClass('clockpicker-dial-out'), setTimeout(function () {
            E.done()
          }, x / 2)),
          d.prepend(z),
          clearTimeout(v),
    ...
    this.amOrPm = 'PM',
    r.twelvehour && (r.ampmclickable ? (this.spanAmPm.empty(), t('<div id="click-am">AM</div>').on('click', function () {
      ...
      E.amOrPm = 'PM'
    }).appendTo(this.spanAmPm)) : (this.spanAmPm.empty(), t('<div id="click-am">AM</div>').appendTo(this.spanAmPm), t('<div id="click-pm">PM</div>').appendTo(this.spanAmPm))),
    ...
    if (r.twelvehour) for (_ = 1; _ < 13; _ += 1) M = q.clone(),
    I = _ / 6 * Math.PI,
    D = y,
    M.css({
    ...
    m.append(M),
    M.on(p, l);
     else for (_ = 0; _ < 24; _ += 1) M = q.clone(),
    I = _ / 6 * Math.PI,
    D = _ > 0 && _ < 13 ? b : y,
    M.css({
      left: g + Math.sin(I) * D - w,
  ...
  o.prototype.show = function (e) {
    if (!this.isShown) {
      ...
      if (this.hours = + o[0] || 0, this.minutes = + o[1] || 0, this.spanHours.html(this.hours), this.spanMinutes.html(i(this.minutes)), !this.isAppended) {
        ...
        this.options.twelvehour && ('PM' === this.amOrPm ? (this.spanAmPm.children('#click-pm').addClass('text-primary'), this.spanAmPm.children('#click-am').removeClass('text-primary')) : (this.spanAmPm.children('#click-am').addClass('text-primary'), this.spanAmPm.children('#click-pm').removeClass('text-primary'))),
  ...
  o.prototype.clear = function () {
    ...
    '' !== t && (this.input.triggerHandler('change'), this.isInput || this.element.trigger('change')),
    this.options.autoclose && this.input.trigger('blur')
  },
  ...
  t.fn.pickatime = function (e) {
    ...
    return this.each(function () {
      ...
      if (a) 'function' == typeof a[e] && a[e].apply(a, i);
        ...
        var r = t.extend({
        }, o.DEFAULTS, n.data(), 'object' == typeof e && e);
...
function (t) {
  var e = {
    init: function (e) {
      ...
      return this.each(function (i) {
        ...
        function s(i) {
          ...
          for ((!W || w >= 0 && w < C) && (c = v[r(w)], t(c).hasClass('active') || (j.find('.carousel-item').removeClass('active'), t(c).addClass('active')), c.style[_] = u + ' translateX(' + - a / 2 + 'px) translateX(' + s * e.shift * l * n + 'px) translateZ(' + e.dist * l + 'px)', c.style.zIndex = 0, e.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - 0.2 * l, c.style.opacity = tweenedOpacity, c.style.display = 'block'), n = 1; n <= o; ++n) e.fullWidth ? (zTranslation = e.dist, tweenedOpacity = n === o && a < 0 ? 1 - l : 1) : (zTranslation = e.dist * (2 * n + l * s), tweenedOpacity = 1 - 0.2 * (2 * n + l * s)),
          (!W || w + n < C) && ((c = v[r(w + n)]).style[_] = u + ' translateX(' + (e.shift + (x * n - a) / 2) + 'px) translateZ(' + zTranslation + 'px)', c.style.zIndex = - n, c.style.opacity = tweenedOpacity, c.style.display = 'block'),
          e.fullWidth ? (zTranslation = e.dist, tweenedOpacity = n === o && a > 0 ? 1 - l : 1) : (zTranslation = e.dist * (2 * n - l * s), tweenedOpacity = 1 - 0.2 * (2 * n - l * s)),
          (!W || w - n >= 0) && ((c = v[r(w - n)]).style[_] = u + ' translateX(' + ( - e.shift + ( - x * n - a) / 2) + 'px) translateZ(' + zTranslation + 'px)', c.style.zIndex = - n, c.style.opacity = tweenedOpacity, c.style.display = 'block');
          if ((!W || w >= 0 && w < C) && ((c = v[r(w)]).style[_] = u + ' translateX(' + - a / 2 + 'px) translateX(' + s * e.shift * l + 'px) translateZ(' + e.dist * l + 'px)', c.style.zIndex = 0, e.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - 0.2 * l, c.style.opacity = tweenedOpacity, c.style.display = 'block'), d !== w && 'function' == typeof e.onCycleTo) {
        ...
        function u(i) {
          if (q) return i.preventDefault(),
          i.stopPropagation(),
          !1;
          if (!e.fullWidth) {
            var n = t(i.target).closest('.carousel-item').index();
            0 !== r(w) - n && (i.preventDefault(), i.stopPropagation()),
            d(n)
          }
        }
        function d(t) {
          ...
          e < 0 ? j.trigger('carouselNext', [
            Math.abs(e)
          ]) : e > 0 && j.trigger('carouselPrev', [
            e
          ])
        }
        function p(e) {
        ...
        var Q = function (e) {
          ...
          n = i.find('img').first();
          if (n.length) if (n[0].complete) if (n.height() > 0) j.css('height', n.height());
           else {
        ...
        if (e.fullWidth && (e.dist = 0, Q(), N && j.find('.carousel-fixed-item').addClass('with-indicators')), j.hasClass('initialized')) return t(window).trigger('resize'),
        j.trigger('carouselNext', [
          0.000001
        ]),
        !0;
        ...
        void 0 !== window.ontouchstart && (j.on('touchstart.carousel', p), j.on('touchmove.carousel', h), j.on('touchend.carousel', f)),
    ...
    next: function (e, i) {
      t(this).trigger('carouselNext', [
        e,
        i
      ])
    },
    prev: function (e, i) {
      t(this).trigger('carouselPrev', [
        e,
        i
      ])
    },
    set: function (e, i) {
      t(this).trigger('carouselSet', [
        e,
        i
      ])
    },
  ...
  var e = {
    init: function (e) {
      return this.each(function () {
        ...
        a.length || (a = t('<div class="tap-target-wave"></div>'), r.length || ((r = i.clone(!0, !0)).addClass('tap-target-origin'), r.removeAttr('id'), r.removeAttr('style'), a.append(r)), o.append(a));
        var l = function () {
